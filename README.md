...
### 🚀 **خبر خوب: دیگر نیازی به Seed دستی نیست!**

Backend به‌طور خودکار در startup این کارها را انجام می‌دهد:
- ✅ ایجاد Index های دیتابیس
- ✅ Seed کردن Categories، Styles، و Colors (اگر خالی باشند)
- ✅ آماده‌سازی کامل Collections

### Backend
```bash
cd /app/backend
pip install -r requirements.txt
# همین! دیگر نیازی به اجرای seed_*.py نیست
```
...
### بررسی Startup Logs
```bash
# ببینید backend چطور خودکار initialize می‌شود
tail -f /var/log/supervisor/backend.err.log
```

> 💡 **راهنمای کامل:** برای جزئیات بیشتر فایل `AUTO_INIT_GUIDE.md` را مطالعه کنید
